...
export const estadoTurnoEnum = pgEnum('estado_turno_caja', [
  'abierto',
  'cerrado',
]);
...
export const pago = pgTable('pago', {
  ...
  turnoCajaId: uuid('turno_caja_id')
    .notNull()
    .references(() => turnoCaja.id, { onDelete: 'restrict' }),
